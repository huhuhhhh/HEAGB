...
figure(1), plotregression(output_disord,y_test)
figure(2), 
...
plot([0 100],[0 100],'--','linewidth',1.5,'color',[0.5 0.5 0.5])
axis([35 55 35 55])
xlabel('MC/MD \it{\Gamma}\rm_{Disorder} (nm^{-2})')
ylabel('ANN \it{\Gamma}\rm_{Disorder} (nm^{-2})')
...
legend boxoff
xticks([0 10 20 30 35 40 45 50 55])
yticks([0 10 20 30 35 40 45 50 55])
...
print -dpng -r300 disord_prediction