...
[xData, yData, zData] = prepareSurfaceData(Fe_comp, Temp, y_CoFe_ANN*100 );
ft = fittype( 'lowess' );
% Fit model to data.
...
text(0.25,1250,50,'Fe\rightarrowCo','color','k')
...
print -dpng -r300 Co_Fe_Disdiagram_ANN
